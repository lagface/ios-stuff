...
class TrackTableViewController: UITableViewController, UISearchBarDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //cell.textLabel?.text = "Johnny Cash"
        //cell.detailTextLabel?.text = "Ring of Fire"
        
        cell.textLabel?.text = currentTracks[indexPath.row].artist
        cell.detailTextLabel?.text = currentTracks[indexPath.row].track
        //cell.detailTextLabel?.text = String(indexPath.row)    //check for search limit = 100
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        print("searchButtonClicked with \(searchBar.text)")
